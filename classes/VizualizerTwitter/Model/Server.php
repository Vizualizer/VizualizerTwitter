 ...
 * @author Naohisa Minagawa <info@vizualizer.jp>
 */
class VizualizerTwitter_Model_Server extends Vizualizer_Plugin_Model
{
    ...
    public function __construct($values = array())
    {
        ...
        parent::__construct($loader->loadTable("Servers"), $values);
    }
     ...
     */
    public function findByPrimaryKey($server_id)
    {
        $this->findBy(array("server_id" => $server_id));
    }
    ...
    public function findByPrefer()
    {
        ...
        $select->joinLeft($accounts, array($this->access->server_id." = ".$accounts->server_id));
    ...
    public function accounts()
    {
        ...
        return $account->findAllByServerId($this->server_id);
    }
}
